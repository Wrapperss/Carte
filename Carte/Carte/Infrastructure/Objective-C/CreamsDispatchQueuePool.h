...
#ifndef CreamsDispatchQueuePool_h
#define CreamsDispatchQueuePool_h
 ...
 */
@interface CreamsDispatchQueuePool : NSObject
...
extern dispatch_queue_t CreamsDispatchQueueGetForQOS(NSQualityOfService qos);
